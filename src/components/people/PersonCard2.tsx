  ...
  return (
    <div className="relative group group-hover:scale-110 text-center">
      <Link
        ...
        className="card w-40 h-10 md:w-48 md:h-20 bg-blue-400 transition-all duration-400 rounded-lg shadow-lg relative overflow-hidden z-10 flex items-center justify-center group-hover:rounded-lg md:group-hover:rounded-none"
      >
