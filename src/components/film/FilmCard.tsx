...
const FilmCard: React.FC<IFilmCard> = ({ film }) => {
  return (
    <div className="relative group group-hover:scale-110 text-center">
      <div className="card w-40 h-10 md:w-48 md:h-20 bg-green-500 transition-all duration-400 rounded-lg shadow-lg relative overflow-hidden z-10 flex items-center justify-center group-hover:rounded-none">
