...
export default async function PeopleNamePage({ params }: Props) { 
  ...
  if (!person) { 
    return ( 
      <div className="flex min-h-screen justify-center items-center bg-cover bg-center" style={{ backgroundImage: 'url(/imagen-difuminada.png)' }}> 
  ...
  return ( 
    <div className="flex flex-col min-h-screen bg-cover bg-center relative" style={{ backgroundImage: 'url(/imagen-difuminada.png)' }}> 
      <div className="bg-blue-500 w-full sm:w-[600px] md:w-[800px] h-auto p-4 sm:p-6 mx-auto mt-10 mb-10 flex flex-col justify-center items-center rounded-[12px]"> 
        <Link href="/people" className="absolute top-6 left-6 hover:bg-blue-600 transition-shadow rounded-full px-3 py-2 flex items-center justify-center"> 
